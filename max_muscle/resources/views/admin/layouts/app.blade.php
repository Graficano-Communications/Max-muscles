...
<body class="g-sidenav-show  bg-gray-100">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Dashboard , Welcome {{ Auth::user()->name }}</h6>
                </nav>
   ...
   document.getElementById('logout-form').submit();">
    ...
    <script defer type="text/javascript" src="{{ asset('admin/assets/js/jquery.js')}}"></script>
    <script defer type="text/javascript" src="{{ asset('admin/assets/js/jquery-ui.js')}}"></script>
