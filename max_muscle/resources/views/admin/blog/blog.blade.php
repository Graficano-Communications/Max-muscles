            ...
            <div class="col-md-10">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('blog.index') }}">blogs
                        ...
                        <tbody id="BlogSortable">
                            @foreach ($blogs as $key => $blog)
                                <tr id="{{ $blog->id }}">
                                    ...
                                    <td>{{ $blog->title }} </td>
                                    <td><img src="{{ asset('images/blog/' . $blog->banner_image) }}" class="img-resposive"
                                            width="100px" height="50px"></td>
                                    <td><img src="{{ asset('images/blog/' . $blog->thumbnail_image) }}"
                                            class="img-resposive" width="100px" height="50px"></td>
                                    <td style="display: flex;">
                                        <a href="{{ route('blog.edit', $blog->id) }}"><button class="btn btn-success"
